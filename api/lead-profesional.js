...
module.exports=async function handler(req,res){
 ...
 try{
  ...
  const lead={nombre,email,telefono,tipo_unidad:'otro',problema:'Colaboración profesional',marca_modelo:empresa,notas:notes,origen:'profesionales',utm_source:clean(d.utm_source,120)||null,utm_medium:clean(d.utm_medium,120)||null,utm_campaign:clean(d.utm_campaign,180)||null,landing_page:'/profesionales.html',referrer_host:clean(d.referrer_host,180)||null};
