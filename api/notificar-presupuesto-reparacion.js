...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    await sendEmail({ from: FROM, to: request.email, subject: `${request.numero}: presupuesto disponible`, html: emailHtml(request) });
