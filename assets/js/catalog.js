...
const CATALOG = [
  ...
  },
  {
    ...
    longDesc: 'Licencia de software profesional (WinOLS, ECM Titanium, Alientech y otras herramientas) con soporte técnico incluido. Incluye EDC15 Multimap Suite, nuestra herramienta propia para leer, editar y conmutar múltiples mapas (stock / stage1 / eco) en centralitas Bosch EDC15 desde el propio cuadro, sin hardware adicional.',
    features: ['Licencia original, IVA incluido', 'Instalación opcional a pago único', 'Soporte incluido', 'EDC15 Multimap Suite incluido'],
    ...
    variants: [
      { id: 'licencia', name: 'Licencia', desc: 'Licencia de software, IVA incluido.', price: 199 },
      { id: 'instalacion', name: 'Instalación (pago único)', desc: 'Instalación y configuración del software, IVA incluido.', price: 30 },
    ],
