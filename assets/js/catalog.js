...
const CATEGORIES = [
  ...
  { id: 'file-service', label: 'File Service' },
...
const CATALOG = [
  ...
  {
    id: 'file-service-online',
    name: 'File Service — modificación online',
    ...
    stock: 'stock',
    isProduct: true,
    keywords: ['file service', 'archivo', 'fichero', 'remap online', 'stage1', 'egr', 'dpf', 'adblue'],
    shortDesc: 'Envíanos tu archivo original y recíbelo modificado en horas, sin enviar ninguna pieza.',
    longDesc: 'Servicio 100% online: subes el archivo original leído con tu propio equipo, indicas la modificación que necesitas (Stage 1, EGR, DPF, AdBlue...) y te devolvemos el archivo listo para escribir.',
    features: ['100% online, sin envío de piezas', 'Entrega en horas', 'Compatible con la mayoría de marcas y herramientas'],
    compatibility: ['Archivos leídos con KESS, KTAG, MPPS, PCMflash y equivalentes', 'Gasolina y diésel, turismo y ligero comercial'],
    license: 'Servicio por archivo, sin licencia recurrente',
    requirements: ['Archivo original en formato .bin/.ori del equipo de lectura', 'Datos del vehículo y motorización'],
    support: 'Revisión y reenvío incluidos si el archivo no enciende a la primera',
    variants: [
      { id: 'stage1', name: 'Stage 1', desc: 'Optimización de potencia y par conservando fiabilidad.', price: 39 },
      { id: 'egr-dpf', name: 'EGR / DPF / AdBlue', desc: 'Desactivación de sistemas anticontaminación (uso off-road).', price: 59 },
    ],
    related: ['edc15-multimap-suite', 'software-licencias', 'diagnostico-avanzado'],
  },
];
