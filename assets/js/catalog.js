...
const CATALOG = [
  ...
  },
  {
    ...
    isProduct: true,
    isSoftware: true,
    keywords: ['software', 'winols', 'ecm titanium', 'alientech', 'licencia', 'edc15', 'multimap', 'stage1', 'mapas', 'chiptuning'],
    shortDesc: 'Software profesional para diagnóstico, codificación y reparación, incluyendo nuestro EDC15 Multimap Suite propio.',
    longDesc: 'Licencias originales de WinOLS, ECM Titanium, Alientech y otras herramientas profesionales, con soporte técnico incluido. Incluye EDC15 Multimap Suite, nuestra herramienta propia para leer, editar y conmutar múltiples mapas (stock / stage1 / eco) en centralitas Bosch EDC15 desde el propio cuadro, sin hardware adicional.',
    features: ['Licencias originales', 'Actualizaciones', 'Soporte incluido', 'EDC15 Multimap Suite incluido'],
    compatibility: ['Windows 10 / 11 (64-bit)', 'Interfaces J2534 y K-Line habituales', 'ECUs Bosch, Siemens, Delphi, Denso', 'Bosch EDC15C2 / EDC15C7 / EDC15V (Multimap Suite)'],
    ...
    variants: [
      ...
      { id: 'edc15-estandar', name: 'EDC15 Multimap Suite — Instalación estándar', desc: '2 mapas conmutables (stock / stage1) en centralitas Bosch EDC15.', price: 149 },
      { id: 'edc15-pro', name: 'EDC15 Multimap Suite — Instalación Pro', desc: '4 mapas conmutables (stock / eco / stage1 / stage2) en centralitas Bosch EDC15.', price: 249 },
    ],
    related: ['programadores-multimarca', 'diagnostico-avanzado', 'recuperacion-bosch-edc17cp54'],
  },
  {
